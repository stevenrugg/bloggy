const siteMetadata = {
  ...
  author: 'Steven Rugg',
  description: 'Zencoder | Online - A blog to express, share & create technology',
  language: 'en-us',
  theme: 'system', // system, dark or light
  siteUrl: 'https://zencoder.online',
  siteRepo: 'https://github.com/stevenrugg/bloggy',
  ...
  comment: {
    ...
    utterancesConfig: {
      ...
      label: 'Comments', // label (optional): Comment 💬
      // theme example: github-light, github-dark, preferred-color-scheme
      // github-dark-orange, icy-dark, dark-blue, photon-dark, boxy-light
      theme: 'Preferred Theme',
      // theme when dark mode
      darkTheme: 'Preferred Theme',
    },
    disqusConfig: {
